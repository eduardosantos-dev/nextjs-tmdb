  ...
  return (
    <>
      ...
      <Flex
        direction="column"
        h="100%"
        bgImage={`https://image.tmdb.org/t/p/w1920_and_h800_multi_faces${show.backdrop_path}`}
        ...
        <Flex
          ...
          <Flex
            ...
            <Flex ml={[0, 4, 6, 8]} mt={[6, 6, 0]} flexDir="column" flex="1">
              <Heading as="h1">{show.name}</Heading>
              <Text fontSize="sm">
                {show.formatted_first_air_date} •{" "}
                {show.genres.map((genre: Genre) => genre.name).join(", ")} •{" "}
